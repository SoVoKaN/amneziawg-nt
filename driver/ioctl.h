...
typedef enum
{
    ...
    AWG_IOCTL_INTERFACE_HAS_JUNK_COUNT = 1 << 4,
    AWG_IOCTL_INTERFACE_HAS_JUNK_MIN_SIZE = 1 << 5,
    AWG_IOCTL_INTERFACE_HAS_JUNK_MAX_SIZE = 1 << 6,
    AWG_IOCTL_INTERFACE_HAS_SIZE_HANDSHAKE_INITIATION = 1 << 7,
    AWG_IOCTL_INTERFACE_HAS_SIZE_HANDSHAKE_RESPONSE = 1 << 8,
    AWG_IOCTL_INTERFACE_HAS_SIZE_HANDSHAKE_COOKIE = 1 << 9,
    AWG_IOCTL_INTERFACE_HAS_SIZE_DATA = 1 << 10
...
typedef DECLSPEC_ALIGN(8) struct _AWG_IOCTL_INTERFACE
{
    ...
    USHORT JunkMinSize;
    USHORT JunkMaxSize;
    USHORT SizeHandshakeInitiation;
    USHORT SizeHandshakeResponse;
    USHORT SizeHandshakeCookie;
    USHORT SizeData;
} AWG_IOCTL_INTERFACE;
