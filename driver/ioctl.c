...
static_assert(
    ...
    "Non-symmetric peer stacking");
static_assert(
    SIZE_OF_EMBEDDED(AWG_IOCTL_PEER, AWG_IOCTL_PEER) == (sizeof(AWG_IOCTL_PEER)),
    "Non-symmetric peer stacking");
static_assert(
    SIZE_OF_EMBEDDED(AWG_IOCTL_ALLOWED_IP, AWG_IOCTL_ALLOWED_IP) ==
        SIZE_OF_EMBEDDED(AWG_IOCTL_ALLOWED_IP, AWG_IOCTL_PEER),
...
SetPeer(
    ...
    _Inout_ CONST volatile AWG_IOCTL_PEER **UnsafeIoctlPeerPtr,
